...
@section('content')
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="about__main center">
                        <img src="{{ asset('themes/default') }}/assets/images/layouts/about-06.png" alt="">
                        <p class="mb-17">Why settle for ordinary when your brand can be extraordinary? Our dedication vows
                            to pave your way towards digital domination.</p>
                        <p class="mb-30">A full service digital agency is here to provide you complete solution of your
                            problems. Our strategical marketing approach covers all aspects to make your brand shine online
                            with increased website traffic and sales. Your online business deserves to be succeeded.</p>
                        <a href="#" class="action-btn"><span>Contact Us</span></a>
                    </div>
    ...
    <section class="portfolio" style="margin-top: 4rem">
        <div class="shape"></div>
        <div class="container">
            <div class="row">
                <div class="col-12">
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="portfolio__left">
                            ...
                            <div class="icon">
                                <svg width="38" height="40" viewBox="0 0 38 40" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="#1DE8F1" />
                                    <path d="M9.625 40L0.25 35.3125V22.3438L9.625 27.0312L11.9688 30.4808V36.632L9.625 40Z"
                                        fill="#00D0FF" />
                                    <path d="M19 35.3125L9.625 40V27.0312L19 22.3438V35.3125Z" fill="#00BBFF" />
                                    <path
                                        d="M28.375 27.0312L19.8652 25.1201L19 22.3438L28.375 17.6562L37.75 22.3438L36.7732 25.1759L28.375 27.0312Z"
                                        fill="#B9A2FF" />
                                    <path d="M28.375 40L19 35.3125V22.3438L28.375 27.0312L30.7188 30.4808V36.632L28.375 40Z"
                                        fill="#865FFF" />
                                    <path d="M37.75 35.3125L28.375 40V27.0312L37.75 22.3438V35.3125Z" fill="#5C27FE" />
                                    <path
                                        d="M19 9.375L10.4902 7.46383L9.625 4.6875L19 0L28.375 4.6875L27.3982 7.51961L19 9.375Z"
                                        fill="#7986E8" />
                                    <path d="M19 22.3438L9.625 17.6562V4.6875L19 9.375L21.3438 12.7464V18.9757L19 22.3438Z"
                                        fill="#6E77E5" />
                                    <path d="M28.375 17.6562L19 22.3438V9.375L28.375 4.6875V17.6562Z" fill="#4C5CE1" />
                                </svg>

                            </div>
                            <div class="content">
                                <h5 class="title">Explore Business</h5>
                                <p>Suspendisse tristique neque a lorem placerat pharetra. Class aptent taciti sociosqu ad
                        ...
                        <div class="portfolio-box">
                            ...
                            <div class="content">
                                <h5 class="title">Collect Solutions</h5>
                                <p>Suspendisse tristique neque a lorem placerat pharetra. Class aptent taciti sociosqu ad
                                    litora torquent per conubia nostra, per inceptos himenaeos</p>
                            </div>
                        </div>
                        <div class="portfolio-box">
                            ...
                            <div class="content">
                                <h5 class="title">Solve Business problem</h5>
                                <p>Suspendisse tristique neque a lorem placerat pharetra. Class aptent taciti sociosqu ad
                                    litora torquent per conubia nostra, per inceptos himenaeos</p>
                            </div>
                        </div>
                        <div class="portfolio-box">
                            ...
                            <div class="icon">
                                <svg width="40" height="40" viewBox="0 0 40 40" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="#00D0FF" />
                                    <path d="M20.0001 26.0077L4.5 31.7968L20.0001 37.5858L35.5002 31.7968L20.0001 26.0077Z"
                                        fill="#00D0FF" />
                                    <path d="M35.5001 31.7968L20 37.5858V26.0077L35.5001 31.7968Z" fill="#00BBFF" />
                                    <path
                                    ...
                                    <path
                                        ...
                                        fill="#00BBFF" />
                                    <path d="M30.625 5.42969L20 10.7031L9.375 5.42969L20 0L30.625 5.42969Z"
                                        fill="#7986E8" />
                                    <path
                            ...
                            <div class="content">
                                <h5 class="title">Build The Product</h5>
                                <p>Suspendisse tristique neque a lorem placerat pharetra. Class aptent taciti sociosqu ad
                                    litora torquent per conubia nostra, per inceptos himenaeos</p>
                            </div>
                        </div>
                ...
                <div class="col-xl-6 col-md-6">
                    <div class="portfolio__right">
                        <div class="image">
                            <img src="{{ asset('themes/default') }}/assets/images/layouts/portfolio.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="create" style="margin-top: 2rem">
        <div class="container">
            <div class="row">
                <div class="col-12">
